            ...
            : Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    // Phần bên phải: Thông tin và nút hành động
                    Expanded(
                      flex: 1,
                      child: Container(
...
class ProfileInfoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(icon, color: Colors.black, size: kIsWeb ? 28 : 24),
    ...
    return GestureDetector(
      ...
      child: Container(
        padding: EdgeInsets.symmetric(
            horizontal: 16.0, vertical: kIsWeb ? 14.0 : 12.0),
        decoration: BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.circular(8.0),
          boxShadow: kIsWeb
        ...
        child: Row(
          children: [
            Icon(icon, color: Colors.redAccent, size: kIsWeb ? 28 : 24),
            const SizedBox(width: 16),
            Expanded(
              child: Text(
                label,
